...
public final class EquationDatabase {
	...
	private final String[][] ALGEBRA = {
			...
			/* 3 */{ "X=(a+b)*c", "<math alttext=\"X=(a+b)*c\" id=\"0\"><mrow id=\"0.0\"><mi id=\"0.0.0\">X</mi><mo id=\"0.0.1\">=</mo><mrow id=\"0.0.2\"><mrow id=\"0.0.2.0\"><mo id=\"0.0.2.0.0\">(</mo><mrow id=\"0.0.2.0.1\"><mi id=\"0.0.2.0.1.0\">a</mi><mo id=\"0.0.2.0.1.1\">+</mo><mi id=\"0.0.2.0.1.2\">b</mi></mrow><mo id=\"0.0.2.0.1.3\">)</mo></mrow><mo id=\"0.0.2.0.2\">*</mo><mi id=\"0.0.2.0.2.0\">c</mi></mrow></mrow></math>" },
