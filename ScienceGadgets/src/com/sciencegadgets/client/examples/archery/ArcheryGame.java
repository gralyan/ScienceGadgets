		...
		help.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				case 3:
					...
					// help.getElement().getStyle().setProperty("boxShadow",
					// "none");
					// HTML solveHTML = new
					// HTML("Solve for <b>v<sub>0</sub></b>");
