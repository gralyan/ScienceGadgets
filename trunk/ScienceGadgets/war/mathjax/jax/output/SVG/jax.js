//
//StartMyChange
/*	All my changes are surrounded by these
*	Use this file as a template to change the real files when needed
*/
//EndMyChange
 ...
 */ (function (h, c, e, a) {
    ...
    a.Augment({
        ...
        preTranslate: function (o) {
            ...
            for (u = 0; u < r; u++) {
                ...
                s = z.previousSibling;
                if (s && String(s.className).match(/^MathJax(_SVG)?(_Display)?$/)) {
        ...
        postTranslate: function (q) {
            ...
            for (var o = q.SVGlast, k = q.SVGeqn; o < k; o++) {
                var n = l[o];
                if (n) {
                    n.previousSibling.className = n.previousSibling.className.split(/ /)[0];
                    var p = n.MathJax.elementJax.SVG;
                    if (p.preview) {
                        p.preview.innerHTML = "";
                        n.MathJax.preview = p.preview;
                        delete p.preview
                    }
                }
            }
        ...
        getJaxFromMath: function (k) {
            ...
            return c.getJaxFor(k.nextSibling)
        },
        ...
        length2em: function (q, l, o) {
            ...
            if (p === "in") {
                return k * this.pxPerInch / a.em
            }
            if (p === "cm") {
                return k * this.pxPerInch / a.em / 2.54
            }
            if (p === "mm") {
                return k * this.pxPerInch / a.em / 25.4
            }
            if (p === "mu") {
                return k / 18 * l
            }
        ...
        getBorders: function (o) {
            ...
            for (var p in m) {
                if (m.hasOwnProperty(p)) {
                    ...
                    var n = o.style[k + "Style"];
                    if (n) {
                        l = true;
                        m[p] = this.length2em(o.style[k + "Width"]);
                        m[p + "Style"] = o.style[k + "Style"];
                        m[p + "Color"] = o.style[k + "Color"];
            ...
            for (t = 0, q = B.length; t < q; t++) {
                ...
                if (o >= 55296 && o < 56319) {
                    ...
                    if (this.FONTDATA.RemapPlane1) {
                        var v = this.FONTDATA.RemapPlane1(o, s);
                        o = v.n;
                        s = v.variant
                    }
                } else {
                    k = this.FONTDATA.RANGES;
                    for (l = 0, x = k.length; l < x; l++) {
                        if (k[l].name === "alpha" && s.noLowerCase) {
                            continue
                        }
                        w = s["offset" + k[l].offset];
                        if (w && o >= k[l].low && o <= k[l].high) {
                ...
                if (s.remap && s.remap[o]) {
                    if (s.remap[o] instanceof Array) {
                        var A = s.remap[o];
                        o = A[0];
                        s = this.FONTDATA.VARIANT[A[1]]
                    } else {
                        if (typeof (s.remap[o]) === "string") {
                            B = s.remap[o] + B.substr(t + 1);
                            t = 0;
                            q = B.length;
                            o = B.charCodeAt(0)
                        } else {
                ...
                y = p[o];
                if (y) {
                    y = [r, p.id + "-" + o.toString(16).toUpperCase()].concat(y);
                    u.Add(i.GLYPH.apply(i, y), u.w, 0)
                } else {
                    if (this.FONTDATA.DELIMITERS[o]) {
                        u.Add(this.createDelimiter(o, 0, 1, p), u.w, 0)
                    } else {
                        if (o <= 65535) {
        ...
        extendDelimiterH: function (t, o, m, q, n) {
            ...
            if (o > B) {
                ...
                while (r-- > 0) {
                    var u = a.Element("g", {
                        transform: "translate(" + (z - l / 2 - E * y.l + y.x) + "," + y.y + ") scale(" + E + ",1)"
                    });
    ...
    i.ROW = i.Subclass({
        ...
        Stretch: function () {
            for (var n = 0, k = this.svg.length; n < k; n++) {
                var l = this.svg[n];
                if (l.mml) {
                    l = l.mml.SVGstretchV(this.sh, this.sd)
                }
                if (l.ic) {
                    this.ic = l.ic
                } else {
    ...
    i.HLINE = i.Subclass({
        ...
        Init: function (l, p, r, o, q) {
            ...
            q.x2 = Math.floor(l);
            if (r === "dashed") {
                var s = Math.floor(l / (6 * p)),
                    k = Math.floor(l / (2 * s + 1));
    ...
    i.VLINE = i.Subclass({
        ...
        Init: function (p, o, r, l, q) {
            ...
            q.y2 = Math.floor(p);
            if (r === "dashed") {
                var s = Math.floor(p / (6 * o)),
                    k = Math.floor(p / (2 * s + 1));
                q["stroke-dasharray"] = k + " " + k
            }
            this.SUPER(arguments).Init.call(this, q);
            this.w = this.r = o;
    ...
    c.Register.StartupHook("mml Jax Ready", function () {
        ...
        g.mbase.Augment({
            ...
            SVGsaveData: function (l) {
                ...
                if (this.href) {
                    ...
                    if (l.type === "svg") {
                        ...
                        if (l.removeable && l.element.nodeName === "g") {
                            while (l.element.firstChild) {
                                k.appendChild(l.element.firstChild)
                            }
                        } else {
                ...
                if (a.config.addMMLclasses) {
                    l.removeable = false;
                    l.element.setAttribute("class", "mjx-svg-" + this.type)
			//StartMyChange
			if (this.id) {
				l.element.setAttribute("id","svg" + this.id)
				//l.element.setAttribute("style","height:40px")
				//l.element.setAttribute("style","fill:red;stroke:yellow")
			}
			//EndMyChange
                }
            ...
            SVGgetStyles: function () {
                if (this.style) {
                    ...
                    if (k.style.fontSize) {
                        this.styles.fontSize = k.style.fontSize
                    }
                    if (k.style.color) {
                        this.styles.color = k.style.color
                    }
                    if (k.style.backgroundColor) {
                        this.styles.background = k.style.backgroundColor
                    }
                    if (k.style.fontStyle) {
                        this.styles.fontStyle = k.style.fontStyle
                    }
                    if (k.style.fontWeight) {
                        this.styles.fontWeight = k.style.fontWeight
                    }
                    if (k.style.fontFamily) {
                        this.styles.fontFamily = k.style.fontFamily
                    }
            ...
            SVGhandleSpace: function (n) {
                if (this.useMMLspacing) {
                    ...
                    if (p !== "") {
                        n.x += a.length2em(p, this.SVGgetScale()) / n.scale
                    }
                }
            },
            ...
            SVGgetScale: function () {
                ...
                if (k.scriptlevel !== 0) {
                    ...
                    l = Math.pow(this.Get("scriptsizemultiplier"), k.scriptlevel);
                    k.scriptminsize = a.length2em(this.Get("scriptminsize")) / 1000;
                    if (l < k.scriptminsize) {
                        l = k.scriptminsize
                    }
                }
                l *= a.length2em(k.mathsize) / 1000;
                return l
            },
            SVGgetMu: function (m) {
                var k = 1,
            ...
            SVGcanStretch: function (k) {
                if (this.isEmbellished()) {
                    return this.Core().SVGcanStretch(k)
                }
                return false
            },
        ...
        g.entity.Augment({
            toSVG: function (k, l) {
                return this.SVGhandleVariant(k, l, this.toString().replace(/[\u2061-\u2064]/g, ""))
            }
        });
        g.mo.Augment({
            toSVG: function () {
                this.SVGgetStyles();
                var r = this.svg = this.SVG();
                ...
                var n = this.SVGgetScale(),
                    p = this.SVGgetVariant();
                var w = this.getValues("largeop", "displaystyle");
                if (w.largeop) {
                    p = a.FONTDATA.VARIANT[w.displaystyle ? "-largeOp" : "-smallOp"]
                }
                var v = this.CoreParent(),
                    o = (v && v.isa(g.msubsup) && this !== v.data[0]),
                    k = (o ? this.SVGremapChars : null);
                if (this.data.join("").length === 1 && v && v.isa(g.munderover) && this.CoreText(v.data[v.base]).length === 1) {
                    var s = v.data[v.over],
                        u = v.data[v.under];
                    if (s && this === s.CoreMO() && v.Get("accent")) {
                        k = a.FONTDATA.REMAPACCENT
                    } else {
                        if (u && this === u.CoreMO() && v.Get("accentunder")) {
                            k = a.FONTDATA.REMAPACCENTUNDER
                        }
                    }
                }
                for (var q = 0, l = this.data.length; q < l; q++) {
                    if (this.data[q]) {
                        var y = this.data[q].toSVG(p, n, this.SVGremap, k),
                            t = r.w;
                        if (t === 0 && -y.l > 10 * y.w) {
                            t += -y.l
                        }
                ...
                if (w.largeop) {
                    r.y = (r.h - r.d) / 2 / n - a.TeX.axis_height;
                    if (r.r > r.w) {
                        r.ic = r.r - r.w;
                        r.w = r.r
                    }
            ...
            CoreText: function (k) {
                ...
                while (k.isa(g.mrow) && k.data.length === 1 && k.data[0]) {
                    k = k.data[0]
                }
                if (!k.isToken) {
                    return ""
        ...
        g.mtext.Augment({
            toSVG: function () {
                this.SVGgetStyles();
                var k, m, l = this.SVGgetScale();
                if (this.Parent().type === "merror") {
                    k = this.SVG();
                    this.SVGhandleSpace(k);
                    m = i.G();
                    m.Add(i.TEXT(0.9 * l, this.data.join(""), {
                        fill: "#C00"
                    }));
                    k.Add(i.RECT(m.h + 100, m.d + 100, m.w + 200, {
                        fill: "#FF8",
                        stroke: "#C00",
                        "stroke-width": 50
                    }), 0, 0);
                    ...
                    if (a.config.mtextFontInherit) {
                        k = this.SVG();
                        this.SVGhandleSpace(k);
                        k.Add(i.TEXT(l, this.data.join("")));
                        k.Clean();
        ...
        g.mspace.Augment({
            toSVG: function () {
                ...
                var l = this.SVG(),
                    k = this.SVGgetMu(l);
                l.h = a.length2em(m.height, k) / l.scale;
                l.d = a.length2em(m.depth, k) / l.scale;
                l.w = l.r = a.length2em(m.width, k) / l.scale;
                if (l.w < 0) {
                    l.x = l.w;
                    l.w = l.r = 0
                }
        ...
        g.mfrac.Augment({
            toSVG: function () {
                this.SVGgetStyles();
                var w = this.SVG();
                this.SVGhandleSpace(w);
                var s = this.data[0].toSVG(),
                    y = this.data[1].toSVG();
                var C = this.getValues("displaystyle", "linethickness", "numalign", "denomalign", "bevelled");
                var r = w.scale = this.SVGgetScale(),
                    n = C.displaystyle;
                var x = a.TeX.axis_height * r;
                if (C.bevelled) {
                    var B = (n ? 400 : 150);
                    var A = Math.max(s.h + s.d, y.h + y.d) + 2 * B;
                    var F = a.createDelimiter(47, A);
                    w.Add(s, 0, (s.d - s.h) / 2 + x + B);
                    w.Add(F, s.w - B / 2, (F.d - F.h) / 2 + x);
                    w.Add(y, s.w + F.w - B, (y.d - y.h) / 2 + x - B)
                } else {
                    var o = Math.max(s.w, y.w);
                    var E = a.thickness2em(C.linethickness, r),
                        m, l, D, z;
                    var k = a.TeX.min_rule_thickness / a.em * 1000;
                    if (n) {
                        D = a.TeX.num1;
                        z = a.TeX.denom1
                    } else {
                        D = (E === 0 ? a.TeX.num3 : a.TeX.num2);
                        z = a.TeX.denom2
                    }
                    D *= r;
                    z *= r;
                    if (E === 0) {
                        m = Math.max((n ? 7 : 3) * a.TeX.rule_thickness, 2 * k);
                        l = (D - s.d) - (y.h - z);
                        if (l < m) {
                            D += (m - l) / 2;
                            z += (m - l) / 2
                        ...
                        m = Math.max((n ? 2 : 0) * k + E, E / 2 + 1.5 * k);
                        l = (D - s.d) - (x + E / 2);
                        if (l < m) {
                            D += m - l
                        }
                        ...
                        w.Add(i.RECT(E / 2, E / 2, o + 2 * E), 0, x)
                    }
                    w.Align(s, C.numalign, E, D);
                    w.Align(y, C.denomalign, E, - z)
                }
                w.Clean();
            ...
            SVGhandleSpace: function (k) {
                if (!this.texWithDelims) {
                    k.x = (this.useMMLspacing ? 0 : a.length2em(this.texSpacing() || 0)) + 120;
                    k.X = 120
                }
            }
        });
        ...
        g.munderover.Augment({
            toSVG: function (F, C) {
                ...
                var M = E.scale = this.SVGgetScale();
                var p = [],
                    K = [],
                    u, J, G, n = -a.BIGDIMEN,
                    I = n;
        ...
        g.msubsup.Augment({
            toSVG: function (G, z) {
                ...
                var K = B.scale = this.SVGgetScale(),
                    E = this.SVGgetMu(B);
        ...
        g.math.Augment({
            ...
            toSVG: function (t, m) {
                if (this.data[0]) {
                    ...
                    n.height = a.Ex(s.H + s.D);
                    n.verticalAlign = a.Ex(-s.D - 2 * a.em);
                    n.marginLeft = a.Ex(-p);
                    n.marginRight = a.Ex(-k);
                    s.element.setAttribute("viewBox", (-p) + " " + (-s.H) + " " + (p + s.w + k) + " " + (s.H + s.D));
        ...
        g.TeXAtom.Augment({
            toSVG: function () {
                ...
                this.SVGhandleSpace(k);
                if (this.data[0] != null) {
                    var l = this.data[0].toSVG(),
                        m = 0;
                    if (this.texClass === g.TEXCLASS.VCENTER) {
                        m = a.TeX.axis_height - (l.h + l.d) / 2 + l.d
                    }
                    k.Add(l, 0, m);
                    k.ic = l.ic
                }
