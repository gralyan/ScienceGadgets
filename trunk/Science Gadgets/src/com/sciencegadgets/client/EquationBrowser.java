...
public class EquationBrowser implements EntryPoint {
	 ...
	 */
	final DatabaseHelperAsync databaseHelper = GWT
	...
	private void fillVarDesc(String equation) {
		...
		//databaseHelper.fetchAllUnits(a);
		//Window.alert(b);
		//Grid g = new Grid(listAllUnits.size(), 1);
		//for (int i=0; i<listAllUnits.size(); i++){
		//	g.setText(i, 0, (String) listAllUnits.get(i));
		//}
		//RootPanel.get().add(g);
	}
